...
public struct BrandSheet<Content: View>: View {
    ...
    private var detentHeight: CGFloat {
        ...
        // La marge du bas laisse respirer le dernier élément au-dessus de
        // l'indicateur d'accueil, que la feuille ne connaît pas d'avance.
        return bodyHeight + Self.handleBlockHeight + MemoBookSpacing.m
    }
